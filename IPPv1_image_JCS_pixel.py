...
array = core.CellArray(redd, 400, 400, (P,P), origin=(0,-500))
SubU.add(array)
array = core.CellArray(green, 400, 400, (P,P), origin=(500,-500))
SubU.add(array)
array = core.CellArray(blue, 400, 400, (P,P), origin=(1000,-500))
SubU.add(array)
array = core.CellArray(black, 400, 400, (P,P), origin=(1500,-500))
SubU.add(array)
...
# 	# 		print Crr, Mrr, Yrr, 'c m y'
	...
	# highest colour value as it has the greatest influence on the overall colour
			...
			print 'Rr', Rr, 'Gr', Gr, 'Br', Br
			print 'modified','Rrr', Rrr, 'Grr', Grr, 'Brr', Brr
