#### This is version 4.0 to improve saturation correction mechanism ####
#### This is the updated version to correct the over exposure ####
#### Which means all the dimensions has been shrinked ####
...
# global parameters also for reference check
P = 0.23
...
redd=core.Cell('RED')
redd.add(shapes.Rectangle((0.02,0),(0.04,0.16),layer=1))
redd.add(shapes.Rectangle((0.04,0),(0.06,0.16),layer=2))
redd.add(shapes.Rectangle((0.06,0),(0.08,0.16),layer=3))
redd.add(shapes.Rectangle((0.08,0),(0.10,0.16),layer=4))
redd.add(shapes.Rectangle((0.10,0),(0.12,0.16),layer=5))
redd.add(shapes.Rectangle((0.12,0),(0.14,0.16),layer=6))
redd.add(shapes.Rectangle((0.14,0),(0.16,0.16),layer=7))
redd.add(shapes.Rectangle((0.16,0),(0.18,0.16),layer=8))
redd.add(shapes.Rectangle((0.18,0),(0.20,0.16),layer=9))

# GREEN ELEMENT AND PIXEL D140 L180 P230
green=core.Cell('GREEN')
green.add(shapes.Rectangle((0.02,0),(0.04,0.12),layer=1))
green.add(shapes.Rectangle((0.04,0),(0.06,0.12),layer=2))
green.add(shapes.Rectangle((0.06,0),(0.08,0.12),layer=3))
green.add(shapes.Rectangle((0.08,0),(0.10,0.12),layer=4))
green.add(shapes.Rectangle((0.10,0),(0.12,0.12),layer=5))
green.add(shapes.Rectangle((0.12,0),(0.14,0.12),layer=6))
green.add(shapes.Rectangle((0.14,0),(0.16,0.12),layer=7))
green.add(shapes.Rectangle((0.16,0),(0.18,0.12),layer=8))
green.add(shapes.Rectangle((0.18,0),(0.20,0.12),layer=9))

# BLUE ELEMENT AND PIXEL D160 L180 P230
blue=core.Cell('BLUE')
blue.add(shapes.Rectangle((0.02,0),(0.04,0.14),layer=1))
blue.add(shapes.Rectangle((0.04,0),(0.06,0.14),layer=2))
blue.add(shapes.Rectangle((0.06,0),(0.08,0.14),layer=3))
blue.add(shapes.Rectangle((0.08,0),(0.10,0.14),layer=4))
blue.add(shapes.Rectangle((0.10,0),(0.12,0.14),layer=5))
blue.add(shapes.Rectangle((0.12,0),(0.14,0.14),layer=6))
blue.add(shapes.Rectangle((0.14,0),(0.16,0.14),layer=7))
blue.add(shapes.Rectangle((0.16,0),(0.18,0.14),layer=8))
blue.add(shapes.Rectangle((0.18,0),(0.20,0.14),layer=9))


# BLACK ELEMENT AND PIXEL
black=core.Cell('BLACK')
black.add(shapes.Rectangle((0.02,0),(0.04,0.18),layer=1))
black.add(shapes.Rectangle((0.04,0),(0.06,0.18),layer=2))
black.add(shapes.Rectangle((0.06,0),(0.08,0.18),layer=3))
black.add(shapes.Rectangle((0.08,0),(0.10,0.18),layer=4))
black.add(shapes.Rectangle((0.10,0),(0.12,0.18),layer=5))
black.add(shapes.Rectangle((0.12,0),(0.14,0.18),layer=6))
black.add(shapes.Rectangle((0.14,0),(0.16,0.18),layer=7))
black.add(shapes.Rectangle((0.16,0),(0.18,0.18),layer=8))
black.add(shapes.Rectangle((0.18,0),(0.20,0.18),layer=9))
...
#layout.save('20191031_VanGogh_v4.gds')
