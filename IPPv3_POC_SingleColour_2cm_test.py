...
#SubU.add(array)
#array = core.CellArray(green, 32609, 32609, (P,P), origin=(2000,-1500))
#SubU.add(array)

#array = core.CellArray(blue, 21739, 21739, (P,P), origin=(2000*2,-1500))
#SubU.add(array)
array = core.CellArray(blue, 32609, 32609, (P,P), origin=(2000*2,-1500))
SubU.add(array)
...
layout.save('20191018_BD160L180_POC7500um.gds')
# layout.show()
